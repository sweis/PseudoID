...
% LocalWords:  PseudoID login OpenID SSO IDP logins RPs Facebook IDPs Google de
% LocalWords:  MSN SREG CAPTCHA Plaxo SAML URIs anonymized anonymize facto ons
% LocalWords:  anonymizing Netflix anonymization wayness unlinkable unblinding
% LocalWords:  Unlinkability unblinds Chaum's RSA mr unblind BSS signer's BSS's
% LocalWords:  unblinded PsuedoID IP JavaScript SSL TLS API IDP's iframe
% LocalWords:  pseudoid
